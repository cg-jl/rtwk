...
static inline vec3 operator*(double t, vec3 v) {
    return vec3(t * v.e[0], t * v.e[1], t * v.e[2]);
}

static inline vec3 operator*(vec3 v, double t) { return t * v; }

static inline vec3 operator/(vec3 v, double t) { return (1 / t) * v; }
...
static inline vec3 refract(vec3 uv, vec3 n, double cos_theta, double etai_over_etat) {
